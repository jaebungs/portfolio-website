  ...
  return (
    ...
    >
      ...
      <p className="modal__p">
        I enjoy and appreciate good drinks. However, my girlfriend and I found that searching for an
        easy cocktail recipe takes time.
        <br></br>
        Often recipes are filled with useless information, so I scroll all the way down. Once I
        reach the ingredient section, I find that I don’t have all the ingredients and need to
        repeat again. I just didn’t like to repeat the process.
      </p>
      ...
      <p className="modal__p">
        ...
        <br></br>
        Even if the user does not have all the ingredients, this app should be able to suggest other
        options.
      </p>
      ...
      <div className="modal__grid-table">
        ...
        <p className="table__solution">
          ...
          After the user JWT will be stored in the client's localStorage or session storage or
          cookie and it will be used on every request either in the header or body.<br></br>
          Once the server receives the jwt, it decodes to validate the user.<br></br>
          Advantages of JWT<br></br>
          It saves the server memory since it does not need to record, only needs to issue a token.
          <br></br>
          <br></br>
          Caution!<br></br>
          ...
          <br></br>
          <br></br>
          JWT contains 3 parts (header, payload, signature).<br></br>I used jsonwebtoken npm
          package, the order is (payload, secretOrPrivateKey, [options, callback]). Actually code is
          <SyntaxHighlighter
            language="javascript"
        ...
        <p className="table__solution">
          ...
          There are many articles about XSS and CSRF and how to prevent attacks. I will need to read
          again and practice.<br></br>
          Implemented expiration time in JWT. Using expiration can increase the chance of
          compromised tokens becoming useless.
        </p>
        ...
        <p className="table__problem">
          Both server and client files are in one same folder. This caused many problems during
          deployment due to my lack of experience.
        </p>
        <p className="table__solution">
        ...
        <p className="table__problem">
          Too many manual testing on API calls, Redux state changes, component rendering, filter and
          search functions.
        </p>
        <p className="table__solution">
          Yes I heard benefits of testing a lot, but I haven't felt any necessity before. However,
          although the app is small, I had to do lots of manual checking for API calls and page
          renderings, etc. <br></br>
        ...
        <p className="table__solution">
          ...
          JPEG is better because of its smaller file size compared to PNG. PNG quality is better,
          but differences are hard to notice with eyes. Thus, JPEG wins over PNG.
        </p>

        <p className="table__problem">
          Production site renders too slow because of the bundle size.
        </p>
        <p className="table__solution">
      ...
      <ol>
        <li>
          Love Redux hooks! (useSelector, useDispatch). These two hooks simply replaced
          mapStateToProps and Connect. As a result, the code got simpler, shorter and easy to track.
        </li>
